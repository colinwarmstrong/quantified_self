...
##### Food Endpoints
- GET [/api/v1/foods](https://quantifiedself1.herokuapp.com/api/v1/foods) - Returns information about all foods currently in the database
- GET [/api/v1/foods/:id](https://quantifiedself1.herokuapp.com/api/v1/foods/1) - Returns information about a specific food
- POST /api/v1/foods - Allows creating a new food with paramaters in this form: `{ "food": { "name": "Name of food here", "calories": "Calories here"} }`
